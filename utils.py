#utils for EDA from https://github.com/allmeidaapedro
'''
...
def load_object(file_path):
    ...
    Raises:
        Exception: If any exception occurs during the file loading process, a standard exception is raised with
